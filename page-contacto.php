...
<main class="site-main" style="padding-top: 100px;">
    ...
    <!-- Sección de Contacto (Similar a la de la Home) -->
    <section class="sp bg-white" id="contacto" style="padding: 80px 0;">
        <div class="wrap">
                ...
                <div>
                    <ul class="contact__list">
                        <li class="contact__li">
                            ...
                            <div>
                                <div class="contact__label"><?php echo mt_translate( 'Teléfono y WhatsApp', 'Phone & WhatsApp' ); ?></div>
                                <a href="tel:+34662024136" class="contact__val">+34 662 02 41 36</a>
                            </div>
                        </li>
                        <li class="contact__li">
                            <div class="contact__ico">
                            ...
                            <div>
                                ...
                                <a href="mailto:info@metransfers.es" class="contact__val">info@metransfers.es</a>
                            </div>
                        </li>
                        <li class="contact__li">
                            <div class="contact__ico">
                            ...
                            <div>
                                <div class="contact__label"><?php echo mt_translate( 'Ubicación', 'Location' ); ?></div>
                                <span class="contact__val" style="font-weight:600;font-size:18px;color:var(--muted);">Barcelona, <?php echo mt_translate( 'España', 'Spain' ); ?></span>
                            </div>
                        </li>
                        <li class="contact__li">
                            <div class="contact__ico">
                    ...
                    <div style="margin-top:48px;">
                        <button class="btn js-wa-trigger" aria-label="Contactar por WhatsApp" style="background:#25d366;color:#fff;border:none;box-shadow:0 8px 24px rgba(37,211,102,.3);padding:16px 32px;font-size:16px;">
                            ...
                            <?php echo mt_translate( 'Contactar por WhatsApp', 'Contact via WhatsApp' ); ?>
                        </button>
                    </div>
                </div>
                    ...
                    <div class="cform__row">
                        ...
                        <div class="fg">
                            ...
                            <select name="servicio" required>
                                ...
                                <option value="evento"><?php echo mt_translate( 'Empresa o evento', 'Business or event' ); ?></option>
                                <option value="tour"><?php echo mt_translate( 'Tour privado', 'Private tour' ); ?></option>
                                <option value="grupo"><?php echo mt_translate( 'Grupo o celebración', 'Group or celebration' ); ?></option>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if(cform){
        cform.addEventListener('submit', function(e){
            ...
            // Assuming mtAjax is defined globally in the site's footer
            if (typeof mtAjax !== 'undefined') {
                formData.append('security', mtAjax.nonce);
            }
            formData.append('origen', 'Página de Contacto');

            fetch( (typeof mtAjax !== 'undefined' ? mtAjax.ajaxurl : '/wp-admin/admin-ajax.php'), {
                method: 'POST',
                body: formData
            })
            ...
            .then(data => {
                if(data.success) {
                    ...
                    alert(data.data || '<?php echo esc_js( mt_translate( "Ocurrió un error. Inténtalo de nuevo.", "An error occurred. Please try again." ) ); ?>');
                }
            })
            .catch(error => {
                console.error('Error:', error);
                alert('<?php echo esc_js( mt_translate( "Ocurrió un error al enviar el formulario.", "An error occurred while submitting the form." ) ); ?>');
            })
            .finally(() => {
