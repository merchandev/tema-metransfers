...
<section class="hero" id="reservar">
  ...
  <div class="wrap">
    <div class="hero__grid">
      ...
      <!-- TEXTO -->
      <div>
        <p class="tag" style="color: #FFB547;">Traslados privados · Tours · Eventos</p>
        <h1 class="hero__h1">Traslados privados en Barcelona con chófer profesional</h1>
        <p class="hero__lead">Reserva tu recogida en el aeropuerto, puerto, hotel o cualquier dirección. Presupuesto a medida antes de confirmar y atención personalizada las 24 horas.</p>
        <div class="hero__checks">
          <span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"/></svg> Presupuesto a medida</span>
          <span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"/></svg> Cancelación gratuita hasta 24 h antes</span>
          <span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"/></svg> Atención 24/7</span>
        </div>
        <div class="hero__ctas">
          <a href="#panel" class="btn btn-solid">Calcular mi traslado</a>
        ...
        <div class="hero__stats">
          <div>
            ...
            <div class="hero__stat-l">traslados realizados</div>
          </div>
          <div>
            <div class="hero__stat-n">4,8/5</div>
            <div class="hero__stat-l"><a href="https://www.getyourguide.com/es-es/metransfers-s12737/" target="_blank" rel="noopener noreferrer" style="color:inherit;text-decoration:underline;">valoración GetYourGuide</a></div>
          </div>
          <div>
            <div class="hero__stat-n">24/7</div>
            <div class="hero__stat-l">atención personalizada</div>
          </div>
        </div>
      </div>
